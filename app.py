...
def filt(df,comp,btu,sys,conn,fuel,flue,coil,fillopt):
    ...
    # Important: if a boundary overlaps, the tighter/higher range wins.
    # Example: exactly 40,000 BTU chooses HPV100; below 40,000 chooses HPV075.
